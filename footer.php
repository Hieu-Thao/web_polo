<div class="bot">
        <div class="vect">
            <label style="font-weight: 700; margin-top: 20px; font-size:22px;">Về chúng tôi</label>
            <a class="vect" href="#">Giới thiệu</a>
            <a class="vect" href="#">Điều khoản sử dụng</a>
